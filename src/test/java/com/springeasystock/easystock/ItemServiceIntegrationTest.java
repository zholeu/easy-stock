...
public class ItemServiceIntegrationTest {
    ...
    public void testGetAllItems() {
        ItemDTO itemDTO = new ItemDTO(null, "Item A", "Supplier A", 5.0f, 10.5f, 1, 1, 1, new HashSet<>());
        ItemDTO itemDTO2 = new ItemDTO(null, "Item A", "Supplier A", 5.0f, 10.5f, 1, 1, 1, new HashSet<>());
        itemService.createItem(itemDTO);
        itemService.createItem(itemDTO2);
        Pageable pageable = PageRequest.of(0, 10);
        Page<ItemDTO> itemDTOPage = itemService.getAllItems(pageable);
        assertNotNull(itemDTOPage);
    }
